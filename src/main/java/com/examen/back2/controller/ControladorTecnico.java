...
import com.examen.back2.services.ServicioTecnico;
...
public class ControladorTecnico {
    ...
    public ResponseEntity<?> guardar(@RequestBody TecnicoDTO dto) {
        return servicio.guardar(dto);
    }

    @PutMapping(value = "/modificar/{id}", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> modificar(@PathVariable Integer id, @RequestBody TecnicoDTO dto) {
